    ...
    <header className="bg-orange-100  h-46">
      ...
      >
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          <Link
            to="/"
            className={`text-md font-semibold leading-6 text-gray-900 hover:text-orange-600 hover:border-b-2 border-orange-600 ${location.pathname === "/"
          ...
          <Link
            to="/menu"
            className={`text-md font-semibold leading-6 text-gray-900 hover:text-orange-600 hover:border-b-2 border-orange-600 ${location.pathname === "/menu"
                ? "active border-b-2 border-orange-600 text-orange-600"
                : ""
              }`}
          >
          ...
          {(user || isIdInLocalStorage) && (
            <Link
              to="/creaciones"
              className={`text-md font-semibold leading-6 text-gray-900 hover:text-orange-600 hover:border-b-2 border-orange-600 ${location.pathname === "/creaciones"
                  ? "active border-b-2 border-orange-600 text-orange-600"
                  : ""
                }`}
            >
          ...
          <Link
            to="/publicaciones"
            className={`text-md font-semibold leading-6 text-gray-900 hover:text-orange-600 hover:border-b-2 border-orange-600 ${location.pathname === "/publicaciones"
                ? "active border-b-2 border-orange-600 text-orange-600"
                : ""
              }`}
          >
          ...
          <Link
            to="/about"
            className={`text-md font-semibold leading-6 text-gray-900 hover:text-orange-600 hover:border-b-2 border-orange-600 ${location.pathname === "/nosotros"
                ? "active border-b-2 border-orange-600 text-orange-600"
                : ""
              }`}
          >
