...
function Creaciones() {
  ...
  return (
    <div className='flex flex-col items-center justify-start w-full md:px-20'>
      ...
      <div className='flex flex-row flex-wrap justify-center md:justify-start space-x-4 p-5'>
      ...
      <div className='flex flex-row flex-wrap justify-center gap-8 pb-6 mt-5'>
        {creation &&
          creation.slice((page - 1) * perPage, (page - 1) * perPage + perPage).map((elem, index) => (
            <>
              {
                !elem.isDeleted ? (
                  <CardCreations
